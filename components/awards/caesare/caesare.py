...
Builder.load_file("./components/awards/caesare/caesare.kv")


class Caesare(MDCard, ButtonBehavior):

    def __init__(self, **kwargs):
        local_code = [i for i in ACCOUNT.keys()][0]
        supernova = ACCOUNT[local_code]["awards"]["caesare"]
        print(supernova)
        self.name = "caesare".upper()
