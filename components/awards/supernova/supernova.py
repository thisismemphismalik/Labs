...
Builder.load_file("./components/awards/supernova/supernova.kv")


class Supernova(MDCard, ButtonBehavior):

    def __init__(self, **kwargs):
        local_code = [i for i in ACCOUNT.keys()][0]
        supernova = ACCOUNT[local_code]["awards"]["supernova"]
        print(supernova)
        self.name = "supernova".upper()
